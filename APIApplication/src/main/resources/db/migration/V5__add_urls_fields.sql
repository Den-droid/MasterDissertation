...
VALUES ('userId', 'Ідентифікатор', 'Унікальний числовий ідентифікатор користувача', 0),
       ...
       ('minValue', 'Мінімальне значення функції', 'Мінімальне значення функції', 1),
       ('maxValue', 'Максимальне значення функції', 'Максимальне значення функції', 1),
...
values((select id from urls where url = '/api/permissions' and method = 1),
       ...
       ((select id from urls where url = '/api/functions' and method = 1),
        ...
        true, false),
       ((select id from urls where url = '/api/functions' and method = 1),
        (select id from fields where name = 'minValue'),
        true, true),
       ((select id from urls where url = '/api/functions' and method = 1),
        (select id from fields where name = 'maxValue'),
        true, true),
       ((select id from urls where url = '/api/functions' and method = 1),
        (select id from fields where name = 'subjectId'),
        true, false),
