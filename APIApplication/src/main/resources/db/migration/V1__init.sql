...
create table assignments (attempts_remaining integer not null, function_id integer, has_correct_answer boolean not null, id integer generated by default as identity, status smallint check (status between 0 and 4), user_assigned_id integer, primary key (id));
...
create table users (group_id integer, id integer generated by default as identity, is_approved boolean, email varchar(255), forgot_password_token varchar(255), password varchar(255), refresh_token varchar(255), primary key (id));
