package org.apiapplication.constants;

public class EntityName {
    public static final String ROLE = "Роль";
    public static final String USER = "Користувач";
    public static final String ASSIGNMENT = "Завдання";
    public static final String USER_ASSIGNMENT = "Завдання користувача";
